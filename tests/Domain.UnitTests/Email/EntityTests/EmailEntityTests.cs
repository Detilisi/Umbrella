...
{
    [Test]
    public void Create_ThrowsArgumentNullException_ForNullSender()
    {
        Assert.Throws<ArgumentNullException>(() =>
        EmailEntity.Create(null, [EmailAddress.Create("test@example.com")], EmailSubjectLine.Create("Subject"), EmailBodyText.Create("Body")));
    }
    ...
    {
        Assert.Throws<ArgumentNullException>(() => 
        EmailEntity.Create(EmailAddress.Create("test@example.com"), null, EmailSubjectLine.Create("Subject"), EmailBodyText.Create("Body")));
    }
    ...
    {
        Assert.Throws<ArgumentNullException>(() => 
        EmailEntity.Create(EmailAddress.Create("test@example.com"), [EmailAddress.Create("test@example.com")], null, EmailBodyText.Create("Body")));
    }
    ...
    {
        Assert.Throws<ArgumentNullException>(() => 
        EmailEntity.Create(EmailAddress.Create("test@example.com"), [EmailAddress.Create("test@example.com")], EmailSubjectLine.Create("Subject"), null));
    }
    ...
    {
        //Arrange
        var sender = EmailAddress.Create("test@example.com");
        ...
        //Act
        var email = EmailEntity.Create(sender, recipients, subject, body);

        //Assert
        Assert.Multiple(() =>
        {
            Assert.That(email.Sender, Is.EqualTo(sender));
